...
<div class="container-fluid">
    ...
    <a class="btn btn-outline-primary mt-2" href="${pageContext.request.contextPath}/api/products_manager/create_product"><fmt:message key="products.btn.newProduct"/></a>
        <form action="${pageContext.request.contextPath}/api/products_manager" method="post">
            <div class="row mt-3">
        ...
        <tbody>
            <c:forEach varStatus="i" var="item" items="${products}">
                ...
                <tr>
                    ...
                    <td>
                        <form action="${pageContext.request.contextPath}/api/products_manager/product_status" method="get">
                    ...
                    <td>
                        <a class="nav-link" href="${pageContext.request.contextPath}/api/products_manager/edit_product?id=${item.id}">
                        ...
                        <a class="nav-link" href="${pageContext.request.contextPath}/api/products_manager/delete?id=${item.id}">
